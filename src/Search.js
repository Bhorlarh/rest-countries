...
function Search() {
  return (
    <div className="search-area flex pv3 br2 ml5 items-center">
    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 511.999 511.999" style={{enableBackground: "new 0 0 511.999 511.999;"}} width="18px" height="auto" className="ph4">
      <g>
        <g>
    	   <g>
    ...
    <input className="search-bar mr4" placeholder="Search for a country..."></input>
    </div>
  )
}
